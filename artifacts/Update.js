import { NoOp } from 'reelm-core';
import { addUserProfile, addRepos, currentlyFetchingRepos, setCurrentlyFetchingRepos, lookupUserProfile, addProgammingLanguages, lookupRepos } from './Model';
import { getUserProfile, getUserRepos, getProgrammingLangugesForRepos } from './GithubApi';
export default function update(model, msg) {
    switch (msg.type) {
        case 'OnUsernameSearch':
            const asyncUpdate = {
                ...
                successFunction: (dispatch, newModelState, result) => {
        ...
        case 'FetchLanguagesForRepo':
            const languagesUpdate = {
                ...
                successFunction: (_dispatch, newModelState, result) => {
                    if (result === null) {
        ...
        case 'FetchReposForUser':
            ...
            const reposUpdate = {
                ...
                successFunction: (dispatch, newModelState, result) => {
                    ...
                    repoModels && repoModels.forEach((repo) => {
